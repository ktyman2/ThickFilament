...
#define KPI_STRESS_P			1.0e-5
#define KPI_STRESS_I			1.0e-7
#define PRD_UPD_SINU_STRESS		1.0e-2
...
// Geometric parameters for motors
#define L_MOTBACK_DIST		66.0e-9	
#define L_MOTBACK_CEN_DIST	66.0e-9	
#define ANG_MOT_BEND		0
// Boundaries
...
#define F_NN2S(a)			((a)/KT_IN_J*L_SCALE_IN_M/1.0e9)
#define F_S2NN(a)			((a)*KT_IN_J/L_SCALE_IN_M*1.0e9)
...
void RecordFilamentLength(int), RecordCrosslinkDistance(void);
// Energy 
...
extern double *viscStre, *elasStre, *elasStre2;
